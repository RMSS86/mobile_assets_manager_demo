...
app.title = "New York win IPs"
server = app.server


# Plotly mapbox public token
mapbox_access_token = os.environ['TARGET_ENVIRONMENT_MAP_TOKEN']
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.H2("DASH - Win IP Machine Locator"),
                        html.P(
...
def update_total_rides(datePicked):
    ...
    return "Total Number of Win Machines: {:,d}".format(
...
@app.callback(
    [Output("total-IP-selection", "children"), Output("date-value", "children")],
